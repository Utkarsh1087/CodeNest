...
function Editor() {
    ...
    return (
        <div className="h-full w-full relative editor-glass-container font-mono">
            <style dangerouslySetInnerHTML={{ __html: `
                .editor-glass-container .cm-editor {
                    background-color: transparent !important;
                    font-family: 'JetBrains Mono', 'Fira Code', monospace !important;
                }
                .editor-glass-container .cm-gutters {
                    background-color: transparent !important;
                    border-right: 1px solid rgba(255,255,255,0.05) !important;
                    color: rgba(255,255,255,0.1) !important;
                }
                .editor-glass-container .cm-lineNumbers .cm-gutterElement {
                ...
                .editor-glass-container .cm-activeLineGutter {
                    background-color: transparent !important;
